...
public class Gameplay extends JPanel implements KeyListener, ActionListener {
	...
	/**
	 *  There are issues with the file. At present there are the following issues that will need to be resolved before the application
	 *  should work. Here is a list of the following things to be checked:
	 * 
	 * 	Check the name of the images used for the snake. there are two that are incorrect and will not appear as a bug.
	 *  Check imports that are being used. There is an inpor that is not needed and can be removed. This can be seen under the PMD Report.
	 *  There are two unused variables found in this file. You can see what they are under the PMD report.
	 *  There is a section of code that will trigger the SpotBugs report. You can view it there. However, I have added a comment to this section 
	 * so it will be visible to the you.
	 */
	...
	public Gameplay() {
		...
		//This section of code, while not a bug, will register as a bug, and is uneeded in the code.
